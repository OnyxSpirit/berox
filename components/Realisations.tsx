...
const projects: Project[] = [
  {
    id: "proj_3d",
    title: "Catalogue Numérique 3D",
    category: "Design 3D",
    image: "/catnum.png",
    description: "Catalogue numérique 3D interactif pour la présentation d'immobilier.",
    longDescription: "Un projet pilote visant à combiner esthétique et intéractivité totale. BEROX a conçu le modèle d'un fauteuil avec le changement intéractif des couleurs pour convaincre les clients.",
    challenge: "Modélisation complexes et optimisation des performances.",
    solution: "Algorithmes d'optimisation paramétrique.",
    tech: ["Unity Engine 6", "3ds Max"],
    year: "2026",
    client: "Direct Service"
  },
  {
    id: "proj_web",
    title: "Gestion Temps Réel pour l'Accadémie de Tennis de Brazzaville",
    category: "Applications Web, Dashboard Temps Réel",
    image: "/atb.png",
    description: "Application d'administration des clients, des commandes et des factures.",
    longDescription: "Une interface opérationnelle temps réel pour la gestion des opérations de l'Accadémie de ténnis de Brazzaville.",
    challenge: "Afficher des données en temps réel de manière fluide et réactive.",
    solution: "Mise en place d'un store et d'une interface de visualisation disponible pour les superviseurs.",
    tech: ["React 19", "TypeScript", "Tailwind CSS", "Recharts", "WebSockets"],
    year: "2026",
    client: "Accadémie de ténnis de Brazzaville",
    isHot: true
  },
   {
    id: "proj_web",
    title: "Inkluzif Management",
    category: "Gestion de données & Applications Web",
    image: "/ink.png",
    description: "Plateforme de gestion des micro-finances.",
    longDescription: "Un outil sur mesure destiné à la gestion des opérations de micro-financement.",
    challenge: "Gestion des données de micro-financement, des clients et des transactions en temps réel.",
    solution: "Développement d'une interface utilisateur intuitive pour la gestion des opérations de micro-financement.",
  ...
  },
  {
    id: "proj_data",
    title: "Neural Flow",
    category: "Analyse de Données & Gestion de données",
    image: "/data.jpg",
  ...
  },
  {
    ...
    category: "Jeux Vidéo",
    image: "/logos.png",
    description: "Un jeu de plateforme 2D avec des mécaniques de combat uniques.",
    longDescription: "Longoki est un jeu de plateforme 2D qui met en avant des mécaniques de combat innovantes et une expérience de jeu immersive.",
    challenge: "Optimiser les performances du jeu tout en maintenant une expérience de jeu fluide et réactive.",
    solution: "Implémentation d'optimisations de performance et d'une architecture logicielle robuste.",
    tech: ["Unity", "C#"],
    year: "2024",
  ...
  {
    id: "proj_custom",
    title: "Black Inspector",
    category: "Logiciels Sur Mesure",
    image: "/bi.png",
    description: "Logiciel d'organisation de fichiers.",
    longDescription: "Un logiciel de gestion de fichiers intuitif et efficace.",
    challenge: "Organiser et classer efficacement une grande quantité de fichiers divers.",
    solution: "Organisation hiérarchique et classification automatique basée sur les métadonnées des fichiers.",
    tech: ["C#", ".NET 8", "WPF"],
    year: "2024",
    client: "Project Black Inspector"
  }
];
